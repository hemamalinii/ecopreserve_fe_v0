...
export default function AboutPage() {
  ...
  return (
    <div ref={containerRef} className="relative h-screen overflow-hidden bg-black">
      ...
      >
        <h1 className="text-6xl md:text-8xl text-center mb-16">
        ...
        <p className="text-gray-400 text-center text-xl max-w-3xl font-bold">
      ...
      >
        ...
        <p className="text-gray-300 text-center text-xl max-w-3xl font-bold">
      ...
      <div ref={treeRef} className="absolute inset-0 opacity-0">
        ...
        <div ref={content4Ref} className="absolute inset-0 flex flex-col items-center justify-center text-white px-8 opacity-0">
          ...
          <p className="text-gray-400 text-center text-xl max-w-3xl mb-10 font-bold">
          ...
          <button
            ...
            className="inline-block px-12 py-6 bg-blue-500 text-white font-bold text-xl rounded-full hover:bg-blue-600 transition-all shadow-lg hover:shadow-xl transform hover:scale-105"
          >
            Get Started
          </button>
        </div>
