...
import { Wallet, Bell, MapPin, CheckCircle2, FileText, Calendar, Award, ShoppingCart, MessageSquare, ArrowLeft, ExternalLink, Leaf } from "lucide-react";
          ...
          <div className="flex items-center justify-between">
            <div className="flex items-center gap-8">
              ...
              <nav className="hidden md:flex items-center gap-6">
                <Link href="/marketplace" className="text-sm font-medium text-primary transition-colors">
                  Marketplace
                </Link>
              ...
              <Card className="p-8 shadow-lg border-2 backdrop-blur-sm bg-card/95 animate-fade-in">
                ...
                <div className="space-y-3">
                  ...
                  <div className="flex items-center justify-between py-2 border-b border-border">
                    ...
                    <span className="font-semibold font-mono">{project.tokenIdRange}</span>
                  </div>
                </div>
              </Card>
            )}
